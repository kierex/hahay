      ...
      <div className="min-h-screen bg-[#F0F2F5] p-4 text-slate-900 dark:bg-[#18191A] dark:text-slate-100">
        <div className="mx-auto flex min-h-[calc(100vh-2rem)] w-full max-w-md flex-col justify-center space-y-6">
          <div className="space-y-2 text-center">
            ...
            <h1 className="text-3xl font-bold text-slate-950 dark:text-white">DEVX BOOST</h1>
  ...
  return (
    <div className="min-h-screen bg-[#F0F2F5] p-4 text-slate-900 dark:bg-[#18191A] dark:text-slate-100">
      <div className="mx-auto max-w-5xl space-y-4">
          ...
          <div className="mx-auto flex max-w-5xl items-center justify-between gap-3">
            <div className="flex min-w-0 items-center gap-3">
              ...
              <div className="min-w-0">
                <p className="truncate font-bold">DEVX BOOST</p>
        ...
        <p className="pb-4 text-center text-xs text-slate-400">DEVX BOOST — v4.0</p>
      </div>
